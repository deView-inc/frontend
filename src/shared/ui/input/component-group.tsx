...
import { Textarea } from '~&/shared/ui/textarea/component';

import { Input } from './component';
import {
    type TInputGroupAddonVariants,
    type TInputGroupButtonVariants,
...
function InputGroupAddon({
    ...
    align = 'inline-start',
    ...props
}: React.ComponentProps<'div'> & TInputGroupAddonVariants) {
    return (
        <div
            role="group"
